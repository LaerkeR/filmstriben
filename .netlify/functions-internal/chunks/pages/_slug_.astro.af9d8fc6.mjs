...
import 'html-escaper';
import { a as filmdatabase, b as $$Moviecard, e as $$Button, g as $$Kryds, c as $$Layout, h as $$Heart } from './_alder_.astro.73f3cbfc.mjs';
...
const $$slug = createComponent(async ($$result, $$props, $$slots) => {
  ...
  <main class="astro-YVBAHNFJ">
    ...
    ${renderComponent($$result2, "Primarycard_karrusel", $$PrimarycardKarrusel, { "temaTitel": "Senest tilf\xF8jet", "class": "astro-YVBAHNFJ" })}
  </main>
` })}
